...
namespace StockMeister.Migrations
{
    ...
    [Migration("20220331074207_UpdateCategoryTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockMeister.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StockMeister.Models.Category", b =>
                {
                    ...
                    b.Property<string>("CountAmountName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OrderAmountName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("StockMeister.Models.Stocktake", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StockMeister.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StockMeister.Models.Stocktake", b =>
                {
                    b.HasOne("StockMeister.Models.Product", "Product")
                        .WithMany()
